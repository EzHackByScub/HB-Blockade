...
typedef bool(__stdcall* PhysicsRaycast)(Ray a1, RaycastHit* hitinfo, float a3, int a4,int a5);
...
//	static inline ScreenToRay oScreenToRayadr;
	...
	static bool  Physics_Raycast_hk(Ray a1, RaycastHit* hitinfo, float a3, int a4,int a5);
