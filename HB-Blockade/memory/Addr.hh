...
//	static inline __int64 sendEos = Utils::sigscan("48 89 ? ? ? 57 48 83 EC ? 80 3D 52 A9 60 02", "GameAssembly.dll");
	...
	static inline __int64 CreatePlayer = Utils::GetAbsoluteAddress(Utils::sigscan("E8 ? ? ? ? FF C3 83 FB 20 7C 91", "GameAssembly.dll"),1,5);
	static inline __int64 RestorePlayer = Utils::GetAbsoluteAddress(Utils::sigscan("E8 ? ? ? ? 48 8B 0D ? ? ? ? 44 39 A1 ? ? ? ? 75 05 E8 ? ? ? ? 33 C9 E8 ? ? ? ? 83 F8 0F ", "GameAssembly.dll"),1,5);
	static inline __int64 SetCurrentWeapon = Utils::GetAbsoluteAddress(Utils::sigscan("E8 ? ? ? ? 4C 8D 5C 24 ? 49 8B 5B 20 49 8B 73 30 49 8B E3 41 5E", "GameAssembly.dll"),1,5);
	static inline __int64 send_currentweapon = Utils::GetAbsoluteAddress(Utils::sigscan("E8 ? ? ? ? 44 39 AE ? ? ? ? 0F 84", "GameAssembly.dll"),1,5);
